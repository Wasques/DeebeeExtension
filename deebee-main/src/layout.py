    ...
    app.layout = html.Div(
        [
            ...
            dbc.Modal(
                [
                    dbc.ModalHeader(
                        html.H1("Generate new data")
                    ),
                    dbc.ModalBody(
                        [
                            html.H5("Table:"),
                            dcc.Dropdown(
                                id="imported_datasets_generate_dropdown",
                                options=EMPTY_LIST,
                                style={
                                    "marginBottom": "20px"
                                }
                                ...
                                [
                                    dbc.Col(
                                        [
                                            dbc.Button(
                                                "Select Target",
                                                id="set_target_generation_button",
                                                color="secondary"
                                            )
                                        ]
                                    ),
                ...
                id="generate_dataset_modal",
            ),
            dbc.Modal(
                [
                    dbc.ModalHeader(
                        html.H1("Choose target")
                    ),
                    dbc.ModalBody(
                        [
                            html.H5("Select a column target for generation:"),
                            dcc.Dropdown(
                                id="table_select_target_generate_dropdown",
                                options=EMPTY_LIST,
                                style={"marginBottom": "20px"}
                            ),
                            html.H5("Write down n outputs for each class:"),
                            daq.NumericInput(
                                id="generation_set_n",
                                max=9999,
                                min=1,
                    ...
                    dbc.ModalFooter(
                        [
                            dbc.Button(
                                "Generate",
                                id="generate_selected_dataset_button",
                                color="secondary"
                            ),
                        ]
                    )
                ],
                id="choose_column_target_to_generate_modal",
            ),
            dbc.Modal(
                [
                    dbc.ModalHeader(
                        html.H1("Fill table blanks")
                    ),
                    dbc.ModalBody(
                        [
                            html.H5("Table:"),
                            dcc.Dropdown(
                                id="imported_datasets_tofill_dropdown",
                                options=EMPTY_LIST,
                                style={
                                    "marginBottom": "20px"
                                }
